...
public class MonthFragment extends Fragment {
   private SharedViewModel sharedViewModel;
    ...
    private String userId = "userId"; // Replace with actual user ID
    ...
    private void fetchAndPopulateData() {
        ...
        dbHelper.getUserDataForPeriod(userId, getMonthStartDate(), getCurrentDate(), new FirestoreDatabaseHelper.FirestoreCallback<List<UserHealthDataModel>>() {
            @Override
